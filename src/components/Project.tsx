            ...
            <div className="py-12 font-custom">
                ...
                <div className="flex flex-row justify-between py-4 pb-12">
                    <div className="flex flex-row items-center gap-4">
                        <svg className={darkMode ? 'fill-current text-white' : 'fill-current text-black'} xmlns="http://www.w3.org/2000/svg" height="16" width="15.5" viewBox="0 0 496 512">
                        ...
                        <a href={project.git} target="_blank" aria-label="Git Project" className="bg-clip-text text-transparent bg-gradient-to-b from-cyan to-blue hover:from-violet hover:to-fuchsia">View Code</a>
                    </div>

                    <div className="flex flex-row items-center gap-4">
                        <svg className={darkMode ? 'fill-current text-white' : 'fill-current text-black'} xmlns="http://www.w3.org/2000/svg" height="16" width="20" viewBox="0 0 640 512">
                        ...
                        {project.deploy ? 
                            <a href={project.deploy} target="_blank" aria-label="Project Deployed" className="bg-clip-text text-transparent bg-gradient-to-b from-cyan to-blue hover:from-violet hover:to-fuchsia">More</a> : 
