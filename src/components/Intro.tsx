...
export function Intro({ darkMode }: darkModeProps) {
    ...
    return (
        <div>
            <div className="flex flex-col gap-10 lg:flex-row justify-between items-center pt-44 pb-8">
                <div className="max-w-xl">
                    <h1 className={`${darkMode ? 'text-gray-200' : 'text-gray-800'} text-6xl uppercase font-bold text-left font-custom lg:animate-slide-in`}>
                        {t('intro_greeting')} 
                ...
                <div className="relative rounded-full overflow-hidden p-3">
                    ...
                    <img src="/pp.jpg" alt="profil picture" className="relative rounded-full size-64 z-10"/>
                </div>
            </div>
        </div>
    )
