            ...
            {/* <div className="gap-4 flex flex-col items-center lg:flex lg:flex-row lg:justify-between pt-6 pb-6 px-24">
                ...
                <div className="flex flex-row gap-10">
                    <a href="https://github.com/RosaBld" target="_blank" rel="noopener noreferrer">
                        <svg className={darkMode ? 'fill-current' : 'fill-current'} xmlns="http://www.w3.org/2000/svg" height="100%" width="18" viewBox="0 0 496 512">
                    ...
                    <a href="https://www.linkedin.com/in/rosalie-boulard/" target="_blank" rel="noopener noreferrer">
                        <svg className={darkMode ? 'fill-current' : 'fill-current'} xmlns="http://www.w3.org/2000/svg" height="100%" width="18" viewBox="0 0 448 512">
